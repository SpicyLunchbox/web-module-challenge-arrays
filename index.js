...
function addFlavor(array, new_flavor){
   array.unshift(new_flavor);
   return array;
}
...
function getFlavorByIndex(array, location){
...
function removeFlavorByName(array, flavor){
    const flavor_location = array.indexOf(flavor); 
    array.splice(flavor_location, 1);
    return array;
}
